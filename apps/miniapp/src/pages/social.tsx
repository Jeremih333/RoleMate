...
import { FileText, Heart, MessageCircle, Plus, Save, ThumbsDown } from 'lucide-react';
  ...
  const save = useMutation({
    mutationFn: () =>
      api.savePublicProfile({
        displayName,
        bio,
        avatarMediaId: profile.data?.avatar_media_id ?? null,
      }),
    onSuccess: () => void queryClient.invalidateQueries({ queryKey: ['public-profile'] }),
  });
