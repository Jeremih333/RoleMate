...
INSERT INTO gift_collections (id, code, title, kind, description, sort_order) VALUES
  ...
  ('gc-standard', 'standard_gifts', 'Standard Gifts', 'standard',
...
INSERT INTO gift_series
  (id, collection_id, code, title, subtitle, lore, rank, total_supply, star_price, sort_order)
VALUES
  ('gs-teddy', 'gc-standard', 'teddy', 'Teddy Bear', 'Standard Gift', NULL, 'plain', NULL, 15, 0),
  ('gs-bouquet', 'gc-standard', 'bouquet', 'Bouquet', 'Standard Gift', NULL, 'plain', NULL, 25, 1),
  ('gs-tulip', 'gc-standard', 'tulip', 'Tulip', 'Standard Gift', NULL, 'plain', NULL, 15, 2),
  ('gs-daisy', 'gc-standard', 'daisy', 'Daisy', 'Standard Gift', NULL, 'plain', NULL, 15, 3),
  ('gs-heart', 'gc-standard', 'heart', 'Heart', 'Standard Gift', NULL, 'plain', NULL, 50, 4),
  ('gs-cake', 'gc-standard', 'cake', 'Cake', 'Standard Gift', NULL, 'plain', NULL, 50, 5),
  ('gs-poop', 'gc-standard', 'poop', 'Poop', 'Standard Gift', NULL, 'plain', NULL, 5, 6),
  ('gs-star', 'gc-standard', 'star', 'Star', 'Standard Gift', NULL, 'plain', NULL, 100, 7);
