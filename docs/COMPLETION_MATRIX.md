...
> Обновление 29 июля 2026: миграции `0008`–`0010`, публикации, рейтинги,
> промокоды, обязательные подписки, роль модератора и исправление запуска из
> `/menu` опубликованы в production. Актуальные версии, 47 автоматических
> тестов, 33 E2E и оставшиеся ручные gates зафиксированы в
...
| Автотесты проходят                         | Подтверждено локально                 | 39 unit/integration/migration и 27 E2E прошли; System, payment lifecycle и все admin-вкладки покрыты mobile regression                                                  |
